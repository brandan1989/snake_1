...
window.snapKitInit = function () {
  ...
  snap.loginkit.mountButton(loginButtonIconId, {
    clientId: 'ebafd651-05c6-4140-83d0-c720a011ae08', /*YOU CHANGE: Must be changed to the development client ID on snapckit*/
    redirectURI: 'https://brandan-snake.glitch.me', /* YOU CHANGE: Must be changed to your glitch project's url AND added as the redirect URI on snapkit */
    scopeList: [
      'user.display_name',
      'user.bitmoji.avatar',
    ],
